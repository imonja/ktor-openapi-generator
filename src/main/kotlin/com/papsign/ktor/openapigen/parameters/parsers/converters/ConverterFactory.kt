...
interface ConverterFactory {
    ...
    fun buildConverterForced(type: KType): Converter = buildConverter(type) ?: error(
        "No ${this.javaClass.declaringClass?.simpleName ?: this.javaClass.simpleName} Converter exists for type $type"
    )
